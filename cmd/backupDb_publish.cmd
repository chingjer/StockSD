...
mysqldump -uroot -p%ppp%99 mystk mystk --no-data >>e:\mysql_bk\mystk.sql
mysqldump -uroot -p%ppp%99 mystk --ignore-table=mystk.stk --ignore-table=mystk.mystk >>e:\mysql_bk\mystk.sql
